...
Sou Meteorologista e Cientista de Dados, com atuação em Ciência de
Dados aplicada à Meteorologia, Ciências Ambientais e ao meio acadêmico.

---

## 🧑 Sobre mim

* ⛅ Doutor em Ciência do Sistema Terrestre pelo INPE e Cientista de Dados pela USP/ESALQ.
...
* 🌍 Defensor da ciência aberta e do compartilhamento de conhecimento.
* 🏠 Natural de Belém do Pará, Brasil.
* 👪 Casado com a Marina e pai do Gabriel.
* 🏃 Gosto de esportes e atividades ao ar livre, como rafting, rapel, trilhas, ciclismo, natação e corrida.
...
Portfólio de projetos em Ciência de Dados, Estatística, Machine
Learning, Séries Temporais, Geoprocessamento e aplicações em
Meteorologia e Ciências Ambientais.

O portfólio reúne estudos e aplicações práticas, com foco em
...
|---|---|
| 📊 Estatística | Regressão, GLM, testes estatísticos, análise de tendências |
| 📈 Séries Temporais | ARIMA, SARIMA, previsão e análise de tendências |
| 🤖 Machine Learning | K-Means, Random Forest, XGBoost e classificação |
| 🌎 Geoprocessamento | GeoPandas, Raster, Cartopy e Google Earth Engine |
| 🌦️ Meteorologia | Precipitação, temperatura, umidade e balanço hídrico |
| 🔥 Ciências Ambientais | Queimadas, clima, seca e monitoramento ambiental |
...
![Statsmodels](https://img.shields.io/badge/-Statsmodels-3B4C6B?style=plastic)
...
## 🌎 Geoprocessamento e Dados Meteorológicos

![Xarray](https://img.shields.io/badge/-Xarray-306998?style=plastic)
![GeoPandas](https://img.shields.io/badge/-GeoPandas-139C5A?style=plastic)
![Rasterio](https://img.shields.io/badge/-Rasterio-139C5A?style=plastic)
![Cartopy](https://img.shields.io/badge/-Cartopy-139C5A?style=plastic)

Também trabalho com dados nos formatos:
...
Experiência com diferentes fontes de dados meteorológicos,
climáticos, ambientais e geoespaciais, incluindo:
...
Nos projetos, busco seguir um fluxo de trabalho estruturado:

1. Aquisição e organização dos dados
2. Análise exploratória
3. Pré-processamento
4. Modelagem estatística ou computacional
5. Validação dos resultados
6. Visualização
7. Interpretação dos resultados

O objetivo é combinar métodos quantitativos, conhecimento do
domínio e ferramentas computacionais para transformar dados em
informação útil para análise e tomada de decisão.
